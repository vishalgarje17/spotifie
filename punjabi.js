...
let songs = [
    { songName: "Mann Meri Jan", filePath: "songs/punjabi/1.mp3", coverPath: "covers/cover.png" },
    { songName: "Kafla", filePath: "songs/punjabi/2.mp3", coverPath: "covers/cover.png" },
   
    { songName: "Tere Vaaste (Zara Hatke Zara Bachke)", filePath: "songs/bollywood/3.mp3", coverPath: "covers/cover.png" },
    { songName: "Kesariya (Brahmastra)d", filePath: "songs/bollywood/4.mp3", coverPath: "covers/cover.png" },
    { songName: "Raatan Lambiyan", filePath: "songs/bollywood/5.mp3", coverPath: "covers/cover.png" },
    { songName: "Bairiya", filePath: "songs/bollywood/6.mp3", coverPath: "covers/cover.png" },
...
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        ...
        audioElement.src = `songs/punjabi/${songIndex + 1}.mp3`;
