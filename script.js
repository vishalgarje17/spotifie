...
let songs = [
    { songName: "AisayKaisay-Hasan Raheem", filePath: "./songs/bollywood/1.mp3", coverPath: "covers/Aisay Kaisay - Hasan Raheem.jpg" },
...
searchForm.addEventListener('submit', function(e) {
  ...
  const filteredSongs = songs.filter(song => {
    // Perform case-insensitive search on the title or artist
    return (
